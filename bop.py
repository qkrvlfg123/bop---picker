...
# --- [데이터 관리 영역] ---
# 앱이 새로고침되어도 메뉴 목록이 날아가지 않게 세션에 꽁꽁 저장해둡니다.
...
with tab1:
    st.subheader("🌅 아침 메뉴")
    if st.button("아침 메뉴 추천받기! ☕"):
        pick = random.choice(st.session_state.breakfast)
...
with tab2:
    ...
    with col1:
        st.link_button("배달의민족 바로가기", "https://www.baemin.com")
    with col2:
        st.link_button("쿠팡이츠 바로가기", "https://www.coupangeats.com")
